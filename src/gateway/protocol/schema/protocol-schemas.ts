...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  AgentsMemoryListParams: AgentsMemoryListParamsSchema,
  AgentsMemoryListResult: AgentsMemoryListResultSchema,
  AgentsMemoryGetParams: AgentsMemoryGetParamsSchema,
  AgentsMemoryGetResult: AgentsMemoryGetResultSchema,
  AgentsMemorySetParams: AgentsMemorySetParamsSchema,
  AgentsMemorySetResult: AgentsMemorySetResultSchema,
  AgentsMemoryDeleteParams: AgentsMemoryDeleteParamsSchema,
  AgentsMemoryDeleteResult: AgentsMemoryDeleteResultSchema,
  AgentsMemoryStatusParams: AgentsMemoryStatusParamsSchema,
  AgentsMemoryStatusResult: AgentsMemoryStatusResultSchema,
