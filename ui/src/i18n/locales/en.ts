...
export const en: TranslationMap = {
  ...
  usage: {
    ...
    metrics: {
      ...
      estimatesNote: "Estimates require session timestamps.",
  ...
  skills: {
    title: "Skills",
    bundledManagedWorkspace: "Bundled, managed, and workspace skills.",
    filter: "Filter",
  ...
  sessions: {
    title: "Sessions",
    activeSessionKeys: "Active session keys and per-session overrides.",
