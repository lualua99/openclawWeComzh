...
export const zh_CN: TranslationMap = {
  ...
  usage: {
    ...
    filters: {
      title: "筛选器",
      loading: "加载中",
      selectDateRange: "选择日期范围并点击刷新以加载使用数据。",
    },
    export: "导出",
    local: "本地",
    utc: "UTC",
    ...
    startDate: "开始日期",
    endDate: "结束日期",
    filterSessions: "筛选会话 (例如 key:agent:main:cron* model:gpt-4o has:errors minTokens:2000)",
    filterClientSide: "筛选 (客户端)",
    sessionsMatch: "{count} / {total} 个会话匹配",
    sessionsInRange: "范围内 {total} 个会话",
    tipFilters: "提示：使用筛选器或点击图表条来筛选日期。",
    removeFilter: "移除筛选器",
    showingFirst: "显示前 1000 个会话。请缩小日期范围以获取完整结果。",
    overview: {
      dailyUsage: "每日使用量",
      noData: "暂无数据",
    ...
    metrics: {
      activityByTime: "按时间统计",
      estimatesNote: "估算需要会话时间戳。",
      noTimelineData: "暂无时间线数据。",
      dayOfWeek: "星期",
      hours: "小时",
      midnight: "午夜",
  ...
  skills: {
    title: "技能",
    bundledManagedWorkspace: "内置、受管和工作区技能。",
    filter: "筛选",
    noSkillsFound: "未找到技能。",
    apiKey: "API 密钥",
    bundled: "内置",
  ...
  sessions: {
    title: "会话",
    activeSessionKeys: "活动会话密钥和每会话覆盖设置。",
