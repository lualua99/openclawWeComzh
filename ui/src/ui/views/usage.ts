...
export function renderUsage(props: UsageProps) {
  ...
  return html`
    ...
    <section class="usage-page-header">
      ...
      <div class="usage-page-subtitle">${t("usage.filters.selectDateRange")}</div>
    </section>
    ...
    <section class="card usage-header ${props.headerPinned ? "pinned" : ""}">
      <div class="usage-header-row">
        <div class="usage-header-title">
          ...
          ${
            props.loading
              ? html`
                  <span class="usage-refresh-indicator">${t("usage.filters.loading")}</span>
                `
              : nothing
          }
          ${
            isEmpty
              ? html`
                  <span class="usage-query-hint">${t("usage.filters.selectDateRange")}</span>
                `
              : nothing
          }
        </div>
        <div class="usage-header-metrics">
          ...
          <button
            ...
            title=${props.headerPinned ? t("usage.unpin") : t("usage.pin")}
      ...
      <div style="margin-top: 12px;">
          ...
          <input
            ...
            placeholder=${t("usage.filterSessions")}
